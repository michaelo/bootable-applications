...
////////////////////////////////
// Protocol: Loaded Image Protocol
#define EFI_LOADED_IMAGE_PROTOCOL_GUID \
    EFI_GuidVal(0x5B1B31A1,0x9562,0x11d2, 0x8E,0x3F,0x00,0xA0,0xC9,0x69,0x72,0x3B)

#define EFI_LOADED_IMAGE_PROTOCOL_REVISION 0x1000

// Simple Text Input Protocol function table
#define X(N, R, P) typedef R EFIAPI EFI_LoadedImageProtocol_##N P;
#include "lil_uefi_loaded_image_funcs.h"
#undef X
...
#define X(N, R, P) EFI_LoadedImageProtocol_##N *N;
#include "lil_uefi_loaded_image_funcs.h"
#undef X
